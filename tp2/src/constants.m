...
LEARNING_RATE       = 1e-5;      % Value to be fine-tuned [1e-3, 1e-4, 1e-5]    (N_HIDDEN_NEURONS = 5, N_FEATURES = 4)
N_HIDDEN_NEURONS    = 8;         % Value to be fine-tuned [2, 5, 8, 10]         (best LEARNING_RATE, N_FEATURES = 4)
N_FEATURES          = 4;         % Value to be fine-tuned [2, 4, 6]             (best LEARNING_RATE, best N_HIDDEN_NEURONS)
